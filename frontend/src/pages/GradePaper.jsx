          ...
          {!processing && (
            <div className="mt-6 border-t border-gray-100 pt-6">
              ...
              {studentDocs.length === 0 ? (
                <div className="rounded-lg border border-dashed border-gray-300 dark:border-slate-600 px-3 py-4 text-xs text-gray-500 dark:text-slate-400">
                  No student answer files yet. Choose <span className="font-medium">Upload Local</span> or <span className="font-medium">Scan QR</span> to add files.
                </div>
              ) : (
