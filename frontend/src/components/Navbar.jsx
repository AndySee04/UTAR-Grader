  ...
  return (
    <nav
      className={`sticky top-0 z-40 border-b backdrop-blur-xl transition-[background-color,box-shadow,border-color] duration-200 ${
        scrolled
          ? 'bg-white/55 dark:bg-slate-900/75 border-gray-200/40 dark:border-slate-700/50 shadow-sm shadow-gray-900/[0.04] dark:shadow-black/20'
          : 'bg-white/85 dark:bg-slate-900/80 border-gray-100 dark:border-slate-800'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex items-center">
            ...
            >
              <img
                ...
                draggable="false"
              />
              <span className="text-lg font-extrabold tracking-[0.12em] text-black dark:text-white hidden sm:block select-none">
                UTAR GRADER
              </span>
            </button>
          ...
          <div className="flex items-center gap-1 sm:gap-3">
            ...
            <div className="relative hidden sm:block" ref={accountMenuRef}>
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-50 dark:bg-slate-800 text-sm hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors"
              >
                <div className="w-7 h-7 rounded-full bg-indigo-100 dark:bg-indigo-900/60 flex items-center justify-center overflow-hidden">
                ...
                <span className="text-gray-600 dark:text-slate-200 font-medium">{user?.name || user?.email}</span>
              </button>
              {accountMenuOpen && (
                <div className="absolute right-0 mt-2 w-44 rounded-xl border border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-900 shadow-lg p-1.5 z-30">
                  <button
                    type="button"
                    onClick={() => {
                      setAccountMenuOpen(false)
                    ...
                    className="w-full text-left px-3 py-2 text-sm text-gray-700 dark:text-slate-200 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800 flex items-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="w-full text-left px-3 py-2 text-sm text-red-600 dark:text-red-400 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/40 flex items-center gap-2"
                  >
        ...
        {/* Mobile nav */}
        {mobileOpen && (
          <div className="md:hidden pb-4 border-t border-gray-100 dark:border-slate-800 pt-2 animate-fade-in">
            <div className="flex flex-col gap-1">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium text-gray-600 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-800 hover:text-gray-900 dark:hover:text-white transition-all duration-200"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/40 transition-all duration-200"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
